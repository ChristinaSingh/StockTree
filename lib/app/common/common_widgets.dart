...
class CommonWidgets {
    ...
    return Container(
      ...
      decoration: decoration ??
          BoxDecoration(
              ...
              border: border ??
                  Border.all(width: 2.px, color: buttonColor ?? primaryColor),
          ...
          ? Container(
              ...
              decoration: decoration ??
                  BoxDecoration(
                      ...
                      border: border ??
                          Border.all(
                              width: 2.px, color: borderColor ?? primaryColor),
  ...
  static Widget dataNotFound() {
    return Center(
      child: SvgPicture.asset(ImageConstants.imageNoDataFound),
    );
  }
  ...
  static Widget customProgressBar(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: inAsyncCall ? backgroundColor ?? primary3Color : primary3Color,
      ),
      clipBehavior: Clip.hardEdge,
      child: inAsyncCall
          ? overlapped
              ...
              child: Row(
                children: [
                  ...
                  Flexible(
                    child: Padding(
                      padding:
                          EdgeInsets.only(left: 5.px, top: 9.px, right: 3.px),
                      child: TextFormField(
                        focusNode: focusNode,
